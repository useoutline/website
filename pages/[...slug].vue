...
useHead({
  title:
    "Page Not Found @ Outline Analytics - Uncover Insights with Privacy-Focused Analytics",
});
...
const wits = [
  ...
  "Our page fashioned itself into a paper plane pioneer, boldly going where no hyperlink has gone before—except into the clouds!",
...
<template>
  <main class="flex flex-column" style="min-height: 100%">
